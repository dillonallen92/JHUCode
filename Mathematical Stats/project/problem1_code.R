...
binom.test(length((fish_ph55$Guarding - fish_ph55$Fanning) > 0), length(fish_ph55$Guarding)) #p-val = 1.9e-6

# tests for ph6
t.test(fish_ph6$Guarding, fish_ph6$Fanning, paired = TRUE) # t = 4.1506, alt hyp
binom.test(length((fish_ph6$Guarding - fish_ph6$Fanning) > 0), length(fish_ph6$Guarding)) #p-val = 1.9e-6

# test for ph6.5
t.test(fish_ph65$Guarding, fish_ph65$Fanning, paired = TRUE) # t = 5.3816, alt hyp
binom.test(length((fish_ph65$Guarding - fish_ph65$Fanning) > 0), length(fish_ph65$Guarding)) #p-val = 1.9e-6

# test for ph7
t.test(fish_ph7$Guarding, fish_ph7$Fanning, paired = TRUE) # t = 5.3816, alt hyp
binom.test(length((fish_ph7$Guarding - fish_ph7$Fanning) > 0), length(fish_ph7$Guarding)) #p-val = 1.9e-6
