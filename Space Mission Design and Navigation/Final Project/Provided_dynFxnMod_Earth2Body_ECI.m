...
% 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [t,x,Phi,Gamma_u,Gamma_v] = Provided_dynFxnMod_Earth2Body_ECI(x0,u,...
    v,tspan,param)
...
% %% Test Call:
% x0 = [7378.05e3;-33.75;-14.667;...
%       0.03;7.35e3;0];
% u = zeros(3,1);
% v = zeros(3,1);
% tspan = [0:1:(105*60)]; % Roughly 1 orbit.
% param = [];
% %
% [t,x,Phi,Gamma_u,Gamma_v] = dynFxn_2Body_ECI_Template(x0,u,v,tspan,param)
